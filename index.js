const demoElement = document.getElementById('demo-element');
        ...
        function selectItem(item) {
            ...
            document.querySelectorAll('.align-self-btn').forEach(btn => btn.classList.remove('active'));
            const alignSelfBtn = Array.from(document.querySelectorAll('.align-self-btn')).find(btn => 
                btn.onclick.toString().includes(`'${alignSelf}'`)
            );
            if (alignSelfBtn) {
            ...
            const orderBtn = Array.from(document.querySelectorAll('.order-btn')).find(btn => 
                btn.onclick.toString().includes(`(${order})`)
            );
            if (orderBtn) {
        ...
        function setAlignSelf(value) {
            if (selectedItem) {
                ...
                selectedItem.classList.add('updating');
                document.querySelectorAll('.align-self-btn').forEach(btn => btn.classList.remove('active'));
                const activeButton = Array.from(document.querySelectorAll('.align-self-btn')).find(btn => 
                    btn.onclick.toString().includes(`'${value}'`)
                );
                if (activeButton) {
                    activeButton.classList.add('active');
        ...
        function setOrder(value) {
            if (selectedItem) {
                ...
                selectedItem.classList.add('updating');
                document.querySelectorAll('.order-btn').forEach(btn => btn.classList.remove('active'));
                const activeButton = Array.from(document.querySelectorAll('.order-btn')).find(btn => 
                    btn.onclick.toString().includes(`(${value})`)
                );
                if (activeButton) {
                    activeButton.classList.add('active');
